...
import { faSchool, faPlayCircle } from '@fortawesome/free-solid-svg-icons';
...
const BasicSubjectCbt: React.FC<RouteComponentProps> = ({ history }) => {
    ...
    return (
        <>
            <h2>
                일반과목 <FontAwesomeIcon icon={faSchool} size="sm" />{' '}문제풀이
            </h2>
            <p>자격증은 학년, 학기 기타 카테고리로 선택하면 풀 수 있습니다.</p>
...
export default withRouter(BasicSubjectCbt);
